#include "cheat_base/imgui/imgui.h"
#include "cheat_base/imgui/imgui_impl_win32.h"
#include "cheat_base/imgui/imgui_impl_dx12.h"
#include <Windows.h>
#include <d3d12.h>
#include <dxgi1_4.h>
#include <tchar.h>
...
// -------------game----------
#define APP_CLASS_NAME TEXT("csgo")
#define APP_WINDOW_TITLE_NAME TEXT("csgo")
...
bool initApp()
{
    ...
    HWND hwnd = CreateWindowEx(
        ...
        APP_WINDOW_TITLE_NAME,                  // title of the window
        ...
        nullptr);                               // pass pointer to current object
    ...
    g_appInstance = (HINSTANCE)instance;
    g_hwnd = hwnd;
...
void stop()
{
    ...
    ::UnregisterClass(APP_CLASS_NAME, g_appInstance);
}

void draw()
{
    {
        ImGui::Checkbox("透视", &csgo->getEsp());
    }

	{
		ImGui::Checkbox("自瞄", &csgo->getAimboot());
	}
}
